...
(() => {
  ...
  _getGSAP() && gsap2.registerPlugin(MotionPathPlugin);
  ...
  var _horizontal = {
    ...
    sc: _scrollCacheFunc(function(value) {
      return arguments.length ? _win4.scrollTo(value, _vertical.sc()) : _win4.pageXOffset || _doc4[_scrollLeft] || _docEl[_scrollLeft] || _body2[_scrollLeft] || 0;
    })
  };
  var _vertical = {
    s: _scrollTop,
    ...
    op: _horizontal,
    sc: _scrollCacheFunc(function(value) {
      return arguments.length ? _win4.scrollTo(_horizontal.sc(), value) : _win4.pageYOffset || _doc4[_scrollTop] || _docEl[_scrollTop] || _body2[_scrollTop] || 0;
    })
  };
  ...
  var _initCore3 = function _initCore4(core) {
    ...
    if (!_coreInitted2 && gsap3 && typeof document !== "undefined" && document.body) {
      ...
      _body2 = _doc4.body;
      _root = [_win4, _doc4, _docEl, _body2];
  ...
  var ScrollTrigger2 = /* @__PURE__ */ function() {
    ...
    _proto.init = function init5(vars, animation) {
      ...
      if (snap3) {
        ...
        "scrollBehavior" in _body3.style && gsap4.set(isViewport ? [_body3, _docEl2] : scroller, {
          scrollBehavior: "auto"
        });
  ...
  // src/utils/gsap.ts
  gsapWithCSS.registerPlugin(ScrollTrigger2, MotionPathPlugin);
  ...
  function stepAnim() {
    gsapWithCSS.set(".step_content", { y: "2rem", opacity: 0.1 });
    gsapWithCSS.set(".step_shape", { scale: 0.5, rotateZ: 180, opacity: 0.1 });
    document.querySelectorAll(".step_content").forEach(function(cardStep) {
      gsapWithCSS.to(cardStep, {
        scrollTrigger: {
          markers: false,
          trigger: cardStep,
          start: "top 75%",
    ...
    document.querySelectorAll(".step_shape").forEach(function(cardShape, index) {
      const triggerElement = document.querySelectorAll(".step_content")[index];
      if (triggerElement) {
        gsapWithCSS.to(cardShape, {
          scrollTrigger: {
            markers: false,
            trigger: triggerElement,
            // Use the matched step_content as trigger
            start: "-50% 75%",
  ...
  function roadPath() {
    gsapWithCSS.to(".accroche_bullet", {
      scrollTrigger: {
        markers: false,
        trigger: "#road",
        start: "top bottom",
  ...
  function teamAnim() {
    gsapWithCSS.set(".ecosystem_collection-item", { y: "1rem", opacity: 0.1 });
    gsapWithCSS.to(".ecosystem_collection-item", {
      scrollTrigger: {
      ...
      ease: "linear",
      stagger: 1
      // Applique un décalage de 0.2 secondes entre chaque animation
    });
  }
  ...
  function spanCMS() {
    (0, import_jquery.default)(document).ready(function() {
      (0, import_jquery.default)(".switch-cms").html(function(_, html) {
  ...
  function hideEmpty() {
    (0, import_jquery.default)(".w-dyn-empty").each(function() {
      (0, import_jquery.default)(this).parent().hide();
    });
  }
  function blogCategories() {
    (0, import_jquery.default)(".cards_a-link.is-reset").click(function() {
      (0, import_jquery.default)("#filter-all").addClass("is-active");
    });
    (0, import_jquery.default)(".cards_radio-filter").click(function() {
      (0, import_jquery.default)("#filter-all").removeClass("is-active");
    });
  }
  function copyBlog() {
  ...
  function swiperReferal() {
    ...
    function updateNavigationVisibility(swiper) {
      ...
      const prevButton = document.querySelector(".referal-c_button-previous");
      const nextButton = document.querySelector(".referal-c_button-next");
      if (prevButton)
